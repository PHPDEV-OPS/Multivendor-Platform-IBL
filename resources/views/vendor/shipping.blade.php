        ...
        <div class="col-md-8">
            <div class="vendor-card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <button class="vendor-btn vendor-btn-primary" data-bs-toggle="modal" data-bs-target="#newZoneModal">
            ...
            <div class="vendor-card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <button class="vendor-btn vendor-btn-primary" data-bs-toggle="modal" data-bs-target="#newMethodModal">
            ...
            <div class="vendor-card mb-4">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        <button class="vendor-btn vendor-btn-outline" data-bs-toggle="modal" data-bs-target="#newZoneModal">
                            <i class="fas fa-globe me-2"></i>Add Shipping Zone
                        </button>
                        <button class="vendor-btn vendor-btn-outline" data-bs-toggle="modal" data-bs-target="#newMethodModal">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="vendor-btn vendor-btn-primary">Create Zone</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="newMethodModal" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="vendor-btn vendor-btn-secondary" data-bs-dismiss="modal">Cancel</button>
                <button type="button" class="vendor-btn vendor-btn-primary">Create Method</button>
            </div>
        </div>
    </div>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const createZoneBtn = document.querySelector('#newZoneModal .vendor-btn-primary');
    const createMethodBtn = document.querySelector('#newMethodModal .vendor-btn-primary');
