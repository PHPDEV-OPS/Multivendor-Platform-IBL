        ...
        <div class="col-md-8">
            <div class="vendor-card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <button class="vendor-btn vendor-btn-primary" data-bs-toggle="modal" data-bs-target="#newTicketModal">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="vendor-btn vendor-btn-primary">Submit Ticket</button>
            </div>
        </div>
    </div>
</div>
