<div class="modal fade login_modal" id="checkot_login_form" tabindex="-1" role="dialog"
        aria-labelledby="checkot_login_form" aria-hidden="true">
                                ...
                                <div class="row">
                                        ...
                                        <div class="input-group custom_group_field mb_35">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text">
                                                    <img src="{{ asset('frontend/amazy/img/my_account/email.svg') }}"
                                                        alt="E-Mail" title="E-Mail">
                                                </span>
                                            </div>
                                            <input type="email" class="form-control"
                                                placeholder="E.g. example@gmail.com"
                                                aria-label="E.g. example@gmail.com">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="input-group custom_group_field ">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text">
                                                    <img src="{{ asset('frontend/amazy/img/my_account/pass.svg') }}"
                                    ...
                                    <div class="col-12">
                                        <button data-bs-toggle="modal" data-bs-dismiss="modal"
                                            data-bs-target="#checkot_login_form_reg"
                                            class="amaz_primary_btn2  style2 radius_5px text-center  w-100 text-uppercase text-center justify-content-center">Register
                                            Now</button>
                                    </div>
                                </div>
                            </form>
