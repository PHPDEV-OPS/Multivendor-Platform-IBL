                    ...
                    <div class="admin-card">
                        ...
                        <div class="card-body">
                            <form>
                                ...
                                <button type="submit" class="admin-btn admin-btn-primary">Save Notification Settings</button>
                            </form>
                        </div>
                    </div>
                </div>
                ...
                <div class="tab-pane fade" id="security">
                    ...
                    <div class="admin-card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <button class="admin-btn admin-btn-outline">Setup Two-Factor Auth</button>
                        </div>
                    </div>
                    ...
                    <div class="admin-card">
                        ...
                        <div class="card-body">
                            ...
                            <button class="admin-btn admin-btn-outline mt-3">Revoke All Sessions</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="tab-pane fade" id="billing">
                    <div class="admin-card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <button class="admin-btn admin-btn-outline me-2">Add Payment Method</button>
                            <button class="admin-btn admin-btn-outline">Remove Selected</button>
                        </div>
                    </div>
                    ...
                    <div class="admin-card mb-4">
                        ...
                        <div class="card-body">
                            <form>
                                ...
                                <button type="submit" class="admin-btn admin-btn-primary">Update Billing Info</button>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="admin-card">
                        ...
                        <div class="card-body">
                            <form>
                                ...
                                <button type="button" class="admin-btn admin-btn-outline me-2">Export My Data</button>
                                <button type="button" class="admin-btn admin-btn-danger">Delete Account</button>

                                <button type="submit" class="admin-btn admin-btn-primary mt-3">Save Privacy Settings</button>
                            </form>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="col-md-6 mb-4">
                                    <div class="card border">
                                        <div class="card-body">
                                            ...
                                            <button class="admin-btn admin-btn-outline btn-sm">Configure</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 mb-4">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    forms.forEach(form => {
        form.addEventListener('submit', function(e) {
            ...
            // Show loading state
            const submitBtn = form.querySelector('.admin-btn-primary');
            if (submitBtn) {
