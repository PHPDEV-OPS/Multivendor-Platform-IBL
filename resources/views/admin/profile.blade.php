            ...
            <div class="admin-card mb-4">
                ...
                <div class="card-body">
                    <form>
                        ...
                        <button type="submit" class="admin-btn admin-btn-primary">Update Personal Information</button>
                    </form>
                </div>
            </div>
            ...
            <div class="admin-card mb-4">
                ...
                <div class="card-body">
                    <form>
                        ...
                        <button type="submit" class="admin-btn admin-btn-primary">Update Business Information</button>
                    </form>
                </div>
            </div>
            ...
            <div class="admin-card mb-4">
                ...
                <div class="card-body">
                    <form>
                        ...
                        <button type="submit" class="admin-btn admin-btn-primary">Update Address Information</button>
                    </form>
                </div>
            </div>
            ...
            <div class="admin-card">
                ...
                <div class="card-body">
                    <form>
                        ...
                        <button type="submit" class="admin-btn admin-btn-primary">Update Social Media Links</button>
                    </form>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            ...
            <div class="admin-card mb-4">
                ...
                <div class="card-body text-center">
                    ...
                    <button class="admin-btn admin-btn-outline">Upload New Picture</button>
                </div>
            </div>
