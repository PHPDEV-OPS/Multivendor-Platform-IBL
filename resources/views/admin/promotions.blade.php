        ...
        <div class="col-md-8">
            <div class="admin-card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <button class="admin-btn admin-btn-primary" data-bs-toggle="modal" data-bs-target="#newPromotionModal">
            ...
            <div class="admin-card mb-4">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        <button class="admin-btn admin-btn-outline" data-bs-toggle="modal" data-bs-target="#newPromotionModal">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="admin-btn admin-btn-primary">Create Promotion</button>
            </div>
        </div>
    </div>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const createPromotionBtn = document.querySelector('#newPromotionModal .admin-btn-primary');
