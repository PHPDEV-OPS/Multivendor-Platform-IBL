            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="d-flex align-items-end h-100">
                        <button class="admin-btn admin-btn-primary me-2" onclick="generateReport()">
                            <i class="fas fa-chart-bar me-2"></i>Generate Report
                        </button>
                        <button class="admin-btn admin-btn-outline me-2" onclick="exportReport()">
                            <i class="fas fa-download me-2"></i>Export
                        </button>
                        <button class="admin-btn admin-btn-secondary" onclick="printReport()">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="admin-btn admin-btn-primary" onclick="confirmExport()">Export Report</button>
            </div>
        </div>
    </div>
</div>
...
function generateReport() {
    ...
    // Show loading state
    const generateBtn = document.querySelector('.admin-btn-primary');
...
function confirmExport() {
    ...
    // Show loading state
    const exportBtn = document.querySelector('#exportModal .admin-btn-primary');
