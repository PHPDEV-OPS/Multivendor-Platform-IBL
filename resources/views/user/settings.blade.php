                    ...
                    <div class="user-card">
                        ...
                        <div class="card-body">
                            <form>
                                ...
                                <button type="submit" class="user-btn user-btn-primary">Save Changes</button>
                            </form>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="user-card">
                        ...
                        <div class="card-body">
                            <form>
                                ...
                                <button type="submit" class="user-btn user-btn-primary">Save Notification Settings</button>
                            </form>
                        </div>
                    </div>
                </div>
                ...
                <div class="tab-pane fade" id="security">
                    <div class="user-card mb-4">
                        ...
                        <div class="card-body">
                            <form>
                                ...
                                <button type="submit" class="user-btn user-btn-primary">Change Password</button>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="user-card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <button class="user-btn user-btn-outline">Setup Two-Factor Auth</button>
                        </div>
                    </div>
                    ...
                    <div class="user-card">
                        ...
                        <div class="card-body">
                            ...
                            <button class="user-btn user-btn-outline mt-3">Revoke All Sessions</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="tab-pane fade" id="billing">
                    <div class="user-card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <button class="user-btn user-btn-outline me-2">Add Payment Method</button>
                            <button class="user-btn user-btn-outline">Remove Selected</button>
                        </div>
                    </div>
                    ...
                    <div class="user-card mb-4">
                        ...
                        <div class="card-body">
                            <form>
                                ...
                                <button type="submit" class="user-btn user-btn-primary">Update Billing Info</button>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="user-card">
                        ...
                        <div class="card-body">
                            <form>
                                ...
                                <button type="button" class="user-btn user-btn-outline me-2">Export My Data</button>
                                <button type="button" class="user-btn user-btn-danger">Delete Account</button>

                                <button type="submit" class="user-btn user-btn-primary mt-3">Save Privacy Settings</button>
                            </form>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="col-md-6 mb-4">
                                    <div class="card border">
                                        <div class="card-body">
                                            ...
                                            <button class="user-btn user-btn-outline btn-sm">Configure</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 mb-4">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    forms.forEach(form => {
        form.addEventListener('submit', function(e) {
            ...
            // Show loading state
            const submitBtn = form.querySelector('.user-btn-primary');
            if (submitBtn) {
