        ...
        <div class="col-md-8">
            <div class="user-card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <button class="user-btn user-btn-primary" data-bs-toggle="modal" data-bs-target="#newZoneModal">
            ...
            <div class="user-card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <button class="user-btn user-btn-primary" data-bs-toggle="modal" data-bs-target="#newMethodModal">
            ...
            <div class="user-card mb-4">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        <button class="user-btn user-btn-outline" data-bs-toggle="modal" data-bs-target="#newZoneModal">
                            <i class="fas fa-globe me-2"></i>Add Shipping Zone
                        </button>
                        <button class="user-btn user-btn-outline" data-bs-toggle="modal" data-bs-target="#newMethodModal">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="user-btn user-btn-primary">Create Zone</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="newMethodModal" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="user-btn user-btn-secondary" data-bs-dismiss="modal">Cancel</button>
                <button type="button" class="user-btn user-btn-primary">Create Method</button>
            </div>
        </div>
    </div>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const createZoneBtn = document.querySelector('#newZoneModal .user-btn-primary');
    const createMethodBtn = document.querySelector('#newMethodModal .user-btn-primary');
